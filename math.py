import math as m
import validation
from validation import split_terms, normalize, equation_strip, split_equation
...
def unwrap_abs(expr: str) -> str:
    return expr[4:-1]  # removes abs( and )
...
print(solve_absolute("abs(x-3)=5"))              # [-2, 8]
print(solve_absolute("abs(x-3)=0"))              # [3]
print(solve_absolute("abs(x-3)=-4"))             # []
print(solve_absolute("abs(x-3)=abs(2x+1)"))      # works